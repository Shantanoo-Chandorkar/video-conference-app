...
import meeting1 from "../assets/p2p-2n.png";
import meeting2 from "../assets/vc-1n.png";
    ...
    <>
      ...
      >
        ...
        >
          <EuiFlexItem>
            <EuiCard
              icon={<EuiImage src={meeting1} alt="icon" size="75%" />}
              title={`Create P2P Meeting`}
          ...
          <EuiFlexItem>
            <EuiCard
              icon={<EuiImage src={meeting2} alt="icon" size="75%" />}
